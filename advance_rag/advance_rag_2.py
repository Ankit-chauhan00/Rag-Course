...
def demo_mult_query_retriver():
    """Multi-Query Retriver generates multiple query perspective."""

    print("=" * 60)
    print("MULTI-QUERY RETRIVER")
    print("Generates multiple perspective on your question")
    print("=" * 60)
    ...
    query = "What tools can i use to build AI application?"


    print(f"\n Orignal Query: {query}")
    print("\nThe retriver will generate multiple query variations...")
    print("(Check INFO logs above for generated queries)\n")

    # Retrive Document
    docs = retriever.invoke(query)

    print(f"Retrived {len(docs)} Unique Document: ")
